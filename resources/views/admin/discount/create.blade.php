                    ...
                    <div class="card-body ">
                        <form action="{{ route('admin.discount.store') }}" method="POST">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <textarea name="description" id="" cols="0" rows="2" class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}">{{old('description')}}</textarea>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input name="percentage" type="number" class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" value="{{old('percentage')}}" min="1" max="100" required/>
